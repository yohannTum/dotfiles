<h1 align="center">
  ...
  <a href="http://www.amitmerchant.com/electron-markdownify">
	<img src="https://neovim.io/logos/neovim-mark-flat.png" width="144" alt="Neovim"/>
  </a>
  <br>
  My neovim config
  <br>
...
```bash
# !This will erase your current nvim config
git clone https://github.com/yohannTum/nvim .config/nvim

# For a first installation, you can run the scripts to test for dependencies
```
